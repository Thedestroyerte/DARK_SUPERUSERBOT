...
OneWord = ["𝗢𝗬𝗬𝗘", "𝗦𝗔𝗦𝗧𝗜", "𝗥𝗔𝗡𝗗𝗜", "𝗔𝗝𝗔", "𝙏𝙀𝙍𝙄", "𝙈𝘼𝘼", "𝙆𝙄", "𝗖𝗛𝗨𝗧", "𝗙𝗔𝗔𝗗", "𝗗𝗨𝗡𝗚𝗔", "𝗛𝗜𝗝𝗗𝗘", "𝗧𝗘𝗥𝗔", "𝗕𝗔𝗔𝗣", "𝙃𝙐", "𝗞𝗜𝗗𝗫𝗫", "𝗦𝗣𝗘𝗘𝗗", "𝗣𝗔𝗞𝗔𝗗", "𝗕𝗘𝗛𝗘𝗡 𝗞𝗘 𝗟𝗔𝗨𝗗𝗘", "𝗔𝗔 𝗕𝗘𝗧𝗔", "𝘼𝙂𝘼𝙔𝘼", "𝙏𝙀𝙍𝙄", "𝙈𝘼𝘼", "𝘾𝙃𝙊𝘿𝙉𝙀", "𝘼𝘽", "𝙏𝙀𝙍𝙄 ", "𝙈𝘼𝘼", "𝘾𝙃𝙐𝘿𝙀𝙂𝙄", "𝙆𝙐𝙏𝙏𝙀", "𝙆𝙄", "𝙏𝘼𝙍𝘼𝙃", "𝘽𝙀𝙏𝘼", "𝙏𝙀𝙍𝙄", "𝙈𝘼𝘼", "𝙆𝙀", "𝘽𝙃𝙊𝙎𝘿𝙀", "𝙈𝙀", "𝙅𝘽𝙇", "𝙆𝙀", "𝙎𝙋𝙀𝘼𝙆𝙀𝙍", "𝘿𝘼𝘼𝙇", "𝙆𝘼𝙍", "𝘽𝘼𝙎𝙎", "𝘽𝙊𝙊𝙎𝙏𝙀𝘿", "𝙎𝙊𝙉𝙂", "𝙎𝙐𝙉𝙐𝙉𝙂𝘼", "𝙋𝙐𝙍𝙄", "𝙍𝘼𝘼𝙏", "𝙇𝘼𝙂𝘼𝙏𝘼𝙍", "𝙏𝙀𝙍𝙄", "𝙈𝘼𝘼", "𝙆𝙀", "𝙎𝘼𝙏𝙃", "𝙎𝙀𝙓", "𝙆𝘼𝙍𝙐𝙉𝙂𝘼🔥", "𝙏𝙀𝙍𝙄", "𝙈𝘼𝘼", "𝙆𝙀", "𝘽𝙊𝙊𝘽𝙎", "𝘿𝘼𝘽𝘼𝙐𝙉𝙂𝘼","𝙓𝙓𝙓","𝙎𝙊𝙐𝙍", "𝙆𝙀𝙀", "𝘾𝙃𝙊𝘿𝙀", "𝙏𝙀𝙍𝙄", "𝙈𝘼𝘼", "𝙆𝙄", "𝘾𝙃𝙐𝙏", "𝙉𝙄𝙇𝘼𝘼𝙈", "𝙆𝘼𝙍𝘿𝙄𝙔𝘼", "𝙈𝘼𝙄𝙉", "𝘽𝙃𝘼𝘿𝙒𝙀", "𝙏𝙔𝙋𝙄𝙉𝙂", "𝙆𝘼𝙍𝙍", "𝙈𝘼𝘿𝘼𝙍𝘾𝙃𝙊𝘿", "𝘼𝘽𝘽", "𝘽𝙃𝘼𝘼𝙂𝙉𝘼", "𝙈𝘼𝙏", "𝘾𝙃𝙐𝙏", "𝙈𝘼𝙍𝘼𝙉𝙄", "𝙆𝙀", "𝙋𝙄𝙇𝙇𝙀",  "𝙏𝙀𝙍𝙄","𝙈𝘼𝘼","𝙆𝘼𝘼","𝘾𝙃𝙐𝙏","𝙈𝘼𝙍𝙐","#𝙁𝙀𝙀𝙇_𝙆𝘼𝙍_𝘼𝙋𝙉𝙀_𝘽𝘼𝘼𝙋_4𝙎𝙏_𝙆𝙊","𝙏𝙀𝙍𝙄","𝙈𝘼𝘼", "𝙆𝙊 𝘾𝙃𝙊𝘿𝙐", "𝙃𝘼𝙒𝘼𝘽𝘼𝙕𝙄", "𝙆𝘼𝙍𝙀𝙂𝘼 𝙏𝙐", "𝙍𝘼𝙉𝘿𝙄", "𝙆𝙀𝙀", "𝙋𝙄𝙇𝙇𝙀", "𝙆𝙔𝘼𝘼 𝙃𝙐𝘼", "𝙉𝙄𝙆𝘼𝙇", "𝙂𝘼𝙔𝙔𝙄", "𝙏𝙀𝙍𝙄", "𝙃𝘼𝙒𝘼𝘽𝘼𝙕𝙄", "𝘾𝙃𝘼𝙈𝘼𝙍", "𝙆𝙄 𝘼𝙐𝙇𝘼𝘼𝘿", "𝗧𝗘𝗥𝗜", "𝗖𝗛𝗨𝗧", "𝗗𝗙𝗡", "𝗞𝗔𝗥𝗗𝗨𝗡𝗚𝗔", "𝗥𝗔𝗡𝗗𝗜 𝗞𝗘", "𝗖𝗛𝗢𝗗𝗘", "𝗠𝗘𝗥𝗘", "𝗟𝗔𝗡𝗗", "𝗣𝗔𝗥 𝗨𝗖𝗛𝗛𝗔𝗟𝗡𝗘", "𝗪𝗔𝗟𝗘", "𝗝𝗛𝗔𝗔𝗧 𝗞𝗘", "𝗕𝗔𝗔𝗟", "𝗧𝗘𝗥𝗜", "𝗕𝗘𝗛𝗘𝗡", "𝗞𝗜", "𝗔𝗔𝗝 𝗣𝗨𝗥𝗜", "𝗖𝗛𝗨𝗧", "𝗞𝗛𝗔𝗝𝗔𝗨𝗡𝗚𝗔", "𝗠𝗔𝗗𝗔𝗥𝗖𝗛𝗢𝗗", "𝗕𝗔𝗞𝗖𝗛𝗢𝗗𝗜 𝗞𝗔𝗥𝗘𝗚𝗔", "𝗧𝗨", "𝗧𝗘𝗥𝗜", "𝗠𝗔𝗔", "𝗞𝗘𝗘", "𝗠𝗨𝗛𝗛 𝗣𝗔𝗥", "𝗔𝗣𝗡𝗘 4𝗦𝗧", "𝗪𝗔𝗟𝗘 𝗕𝗛𝗔𝗜𝗬𝗬𝗢𝗡", "𝗞𝗔 𝗟𝗔𝗡𝗗", "𝗠𝗔𝗥𝗨", "𝗖𝗛𝗔𝗠𝗔𝗥", "𝙏𝙀𝙍𝘼", "𝘾𝙇𝘼𝙉", "𝙈𝙀𝙍𝙀", "𝙇𝘼𝙉𝘿 𝙋𝘼𝙍𝙍", "𝙕𝙃𝘼𝘼𝙏𝙐", "😹😹", "𝙏𝙀𝙍𝙄", "𝘽𝙀𝙃𝙀𝙉 𝙆𝙄", "𝙂𝙐𝙇𝘼𝘽𝙄", "𝘾𝙃𝙐𝙏", "𝘾𝙃𝘼𝘼𝙏", "𝙅𝘼𝘼𝙐𝙉𝙂𝘼", "𝙏𝙀𝙍𝙄", "𝘽𝙀𝙃𝙀𝙉 𝘽𝙀𝙏𝙄𝙔𝙊𝙉", "𝙆𝘼 𝙍𝘼𝙋", "𝙆𝘼𝙍𝘿𝙐𝙉𝙂𝘼", "𝘼𝘼𝙅", "𝙈𝘼𝘿𝘼𝙍𝘾𝙃𝙊𝘿", "𝙏𝙀𝙍𝙀", "𝙈𝙐𝙃𝙃𝙈𝙀", "𝙈𝙀𝙍𝘼", "6 𝙄𝙉𝘾𝙃", "𝙆𝘼𝘼 𝙇𝙊𝘿𝘼", "𝙎𝙋𝙀𝙀𝘿", "𝙇𝘼𝘼", "𝘽𝙃𝙊𝙎𝘿𝙄",  "𝙍𝘼𝙉𝘿𝙄","𝙆𝙀𝙀","𝙋𝙄𝙇𝙇𝙀","𝙏𝙀𝙍𝙄","𝙈𝘼𝘼","𝙆𝘼𝘼","𝘽𝙃𝙊𝙎𝘿𝘼","𝙁𝘼𝘼𝘿𝙐","𝙎𝙊𝙐𝙍","𝙆𝙀𝙀","𝘾𝙃𝙊𝘿𝙀","𝙏𝙀𝙍𝙄","𝙈𝘼𝘼","𝙆𝙀𝙀","𝙉𝙐𝘿𝙀𝙎","𝘽𝙀𝘾𝙃𝙐𝙉𝙂𝘼","𝙍𝘼𝙉𝘿𝙄","𝙆𝙀𝙀","𝙋𝙄𝙇𝙇𝙀","𝙏𝙀𝙍𝙄","𝙈𝘼𝘼","𝘾𝙃𝙊𝘿𝙐","𝙎𝙊𝙐𝙍","𝙆𝙀𝙀","𝙋𝙄𝙇𝙇𝙀","𝙏𝙀𝙍𝙄","𝙈𝘼𝘼","𝘿𝘼𝙄𝙇𝙔","𝘾𝙃𝙊𝘿𝙏𝘼","𝙃𝙐","𝙈𝘼𝘿𝘼𝙍𝘾𝙃𝙊𝘿","𝘼𝙐𝙆𝘼𝘼𝙏","𝘽𝘼𝙉𝘼","𝙇𝙊𝘿𝙀","𝙏𝙀𝙍𝘼","𝘽𝘼𝘼𝙋","𝙃𝙐𝙐","𝙏𝙀𝙍𝙄","𝙂𝙁","𝙆𝘼𝘼","𝘽𝙃𝙊𝙎𝘿𝘼","𝙁𝘼𝘼𝘿𝙐","𝙈𝘼𝘿𝘼𝙍𝘼𝘾𝙃𝙊𝘿","𝙈𝙀𝙍𝙀", "𝙇𝙐𝙉𝘿", "𝙆𝙀𝙀", "𝙋𝙄𝙎𝙎𝙐", "𝙏𝙀𝙍𝙄", "𝙈𝘼𝘼 𝙆𝙄", "𝘾𝙃𝙐𝙏 𝙋𝘼𝙍", "4sᴛ 𝙆𝘼", "𝙇𝙐𝙉𝘿", "𝙈𝘼𝘼𝙍𝘿𝙐𝙉𝙂𝘼", "𝙍𝘼𝘼𝙉𝘿", "𝙆𝙄 𝘼𝙐𝙇𝘼𝘼𝘿", "𝗦𝗢𝗨𝗥", "𝗞𝗘𝗘", "𝗣𝗜𝗟𝗟𝗘", "𝗧𝗘𝗥𝗜", "𝗕𝗘𝗛𝗘𝗡 𝗞𝗢", "𝗔𝗣𝗡𝗜", "𝗝𝗛𝗔𝗔𝗧𝗘𝗜𝗡", "𝗞𝗛𝗜𝗟𝗔", "𝗗𝗨𝗡𝗚𝗔", "𝗦𝗔𝗟𝗘 𝗠𝗔𝗔", "𝗞𝗘𝗘 𝗟𝗢𝗗𝗘", "𝙓𝙃𝙐𝙏", "𝙈𝘼𝙍𝘼𝙉𝙄", "𝙒𝘼𝘼𝙇𝙀", "𝘼𝘼𝙅", "𝙏𝙀𝙍𝙄", "𝙈𝘼𝘼", "𝙆𝘼𝘼", "𝙆𝘼𝙇𝘼", "𝘽𝙃𝙊𝙓𝘿𝘼", "𝙁𝘼𝙏𝙏", "𝙂𝙔𝘼", "𝙓𝙃𝘼𝙈𝘼𝙍", "𝙆𝙄", "𝘼𝙐𝙇𝘼𝘿", "𝘼𝘼𝙅", "𝘽𝘼𝙎𝙎", "𝙏𝙐", "𝙁𝙀𝙀𝙇", "𝙆𝘼𝙍", "𝘼𝙋𝙉𝙀", "𝘽𝘼𝘼𝙋", "𝙕𝙀𝙍𝙊", "𝙆𝙊", "𝙍𝘼𝘼𝙉𝘿", "𝙏𝙀𝙍𝙄", "𝙈𝘼𝙄𝙔𝙔𝘼", "𝙆𝘼", "𝘽𝙃𝙊𝙎𝘿𝘼", "𝙉𝙄𝙇𝘼𝙈", "𝙐𝙁𝙁", "𝙍𝘼𝙉𝘿𝙄", "𝙆𝙀𝙀", "𝘽𝘼𝘾𝙃𝙃𝙀", "𝘼𝙐𝙆𝘼𝙏", "𝘽𝘼𝙉𝘼", "𝙅𝘼𝘼", "𝙁𝙄𝙍𝙍", "𝘼𝙉𝘼", "𝘼𝙋𝙉𝙒", "𝘽𝘼𝘼𝙋", "𝙆𝙀𝙀", "𝙋𝘼𝘼𝙎", "💦💦", "𝘽𝘼𝙎𝙎", "𝘾𝙃𝙐𝘿", "𝙒𝘼𝘼𝙇𝙄", "𝘼𝙋𝙉𝙄", "𝙈𝘼𝘼", "𝙆𝙄", "𝘾𝙃𝙐𝙏", "𝙆𝙄𝘿𝙀", "😹😹", "TERI", "ВЕН EN KI", "IZZAT", "LUTU", "CHAMAR", "TERI", "MAA KO", "APNA LO DA", "CHUSA", "CHUSA KAR", "CHODUNGA", "TERI", "BEHEN", "K O", "RANDI", "BANAKAR", "CHODU", "APNE BAAP" "SE", "TYPING "KAREGA TU", "AUKATLESS", "KID", "", "AJA", "TERI", "MAA KI", "GAJAB", "CHUT", "CHODU", "TERI", "BEHEN", "KI GUL ABI", "CHUT", "MAIN", "APNA LODA", "DAALKAR", "SOJAUN"," ", "KID", "TERI", "NANAI", "ΚΑΑ", "CHUTT", "MARU", "TERII", BEHEN", "KAAA", "BHOSDAA", "MARU", "RANDII", "KEEE", "CHODE", "ΤΕ RI", "DADI", "KAAA", "BOOR", "GARAM", "KARR", "TERE", "PUREE", "кн ANDAN", "KOOO", "CHODUNGAA", "BAAP", "SEE", "BAKCHODI", "KAREGAA "SUARR", "KEEE", "PILLEE", "NAAK", "MEEE", "NETAA", "ВААР", "КООO "KABHII", "NAAH", "BOLNAA", "BETAA", "CHUSS", "LEEE", "MERAA", LODAA", "JAISE", "ALUU", "KAAA", "PAKODAA", "TERI", "MAAA", "BEHEN "GFF", "NANI", "DIIN", "RAAT", "SOTEE", "JAGTEE", "PELTAA", "HUUU

"LODEE", "CHAAR", "CHAWNII", "GHODEE", "PEEE", "TUMM", "MEREE"

"LODEE", "PEE", "TERI", "MAA", "KAAA", "BOOBS", "DABATA HU", "TER

I", "MAA KI", "KAALI", "CHUT", "SAAF", "KARDUNGA", "HAHA

", "TERI", "MAA", "KI", "PYASI", "CHUT", "KI", "AJ

A", "PYAAS", "BHUJAUN", "TERI", "BEHEN", "KI", "CHU

T", "MAIN", "SUTLI", "BOMB", "LAGAKAR", "FOD DU", "RANDI KE

"BACHHE", "#FEEL_KAR_APNE_BAAP_4ST_KA_POWER", "TERI",

RANDI", "BEHEN", "KI", "CHUT", "CHAPPAL HI", "CHAPPAL", "MA

ARU", "ZHAATU", "#4ST_KE_NAAM_SE_KALAPNE_WAALI_RANDI","

", "LODA", "CHUSEGA", "MERA", "TU", "BATA", "SASTI"

RANDI", "WESE", "TERI", "SASTI", "RANDI", "MAA AUR BEHEN

KA", "RATE", "KYA", "HAI", "RNDI KA", "AULAD", "TERI", "MAIYA"

, "KI", "CHUT", "FAAD", "DUNGA", "GANDU", "KALAP", "BAAP", "HU", "к

IDX", "SPEED", "PAKAD", "MERE SE LDEGA", "BAP SE CHUD GYAA", "MERA

LAND LELE", "TERI", "MAA", "CHODNE", "AB", "TERI", "MAA", "CHUC

EGI", "KUTTE", "KI", "TARAH", "BETA", "TERI", "MAA", "KE",

"CHUT", "ME", "APNA", "LAND", "6INCH", "ANDAR", "TAK", "DAL

"DUNGA", "BETICHOD", "FAT", "GYE", "RAAT", "LAGATR", "TER

I", "MAA", "KE", "SAATH", "SUHAGRAT", "MNAUANGA", "TERI",

"MAA", "KE", "BOOBS", "DBAUNGA", "UFF", "TERI", "MAA", "КАА", "С

HUT", "FADU", "RANDI", "KEE", "PILLE", "TERI", "MAA", "KAA", "BHOSD

A", "MARU", "RANDI", "KEE", "CHODE", "TERI", "MAA", "KEE", "GAND",

"BECHUNGA", "RANDI", "KEE", "PILLE", "TERI", "MAA", "CHODU", "SUAR

"KEE", "PILEE", "SPEED", "PKD", "NA", "BAP", "SE LDEGA", "TERI",

"BEHEN", "BHOSDA", "FAD", "FAD", "KAR", "USKI", "CHUT",]
